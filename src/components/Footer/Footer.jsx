  ...
  <div className="row">
    ...
    <div className="col-md-6 p-5">
      ...
      <ul className=' list-unstyled p-4'>
        <li className='  p-2'><i class="fa-solid fa-phone me-1"></i>  +20-01104358546</li>
        <li  className='  p-2'><i class="fa-solid fa-location-dot me-1"></i>  32-moahmed hassan-street,downtwom-Cairo</li>
        <li  className='  p-2'><i class="fa-solid fa-envelope me-1"></i>  Ahmedtahaxx5@gmail.com</li>
      </ul>
    </div>
  </div>
</div>
